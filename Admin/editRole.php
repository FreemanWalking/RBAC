          ...
          if ($result1-> num_rows > 0){ //permission_role found
            ...
            if ($result2-> num_rows > 0){ //Have parent->not default role
              ...
              while ($parent = $result3 -> fetch_assoc()){
                ...
                echo "<td> <button id='s' type='submit' name='perm-sub' style='font-size: 1.5vw; width:100%;  margin-left: auto; margin-right: auto;' formaction='/B/Admin/edit.php?entry_id=".$rolearr[$i]["res"]."' formTarget='_blank'>Save</button> ";
                echo "</form></tr>"; 
                $i++;
              }
