        ...
        <?php      
            ...
            if ($result1){
              while ($row1 = $result1 -> fetch_assoc()){
                ...
                echo "<td> <button id='s' type='submit' name='perm-sub' style='font-size: 1.5vw; width:100%;  margin-left: auto; margin-right: auto;' formaction='add.php?entry_id=".$row1['resource_R']."' formTarget='_blank'>Save</button> ";
                echo "</form></tr>"; 
